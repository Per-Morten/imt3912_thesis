...
\todo{Cite game programming patterns, components. Book not web}

As mentioned earlier there are several forms of entity component systems. Some implementations keep a more traditional OOP implementation, \todo{Cite Game Programming Patterns, components}
