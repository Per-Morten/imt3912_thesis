...
operation types\footnote{\ref{subsec:detailed_operation_types}}, dependencies \todo{Add ref} etc.
...
\todo{Find out which should come first, this or operation types, that decides who should reference each other}
...
\todo{Sort of the same as operation types, the consequences section should perhaps be dropped,
and rather use a longevity section, as everything is a bit more high level again.}
