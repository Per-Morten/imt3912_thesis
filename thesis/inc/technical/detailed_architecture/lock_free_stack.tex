...
\lstinputlisting[language=cpp, caption=Lock-Free Stack Push, label=lst:lock_free_stack_push]{lock_free_stack_code/lock_free_stack_push.py}
...
\lstinputlisting[language=cpp, caption=Lock-Free Stack Pop, label=lst:lock_free_stack_pop]{lock_free_stack_code/lock_free_stack_pop.py}
...
\subsubsection{Exposing Implementation}
