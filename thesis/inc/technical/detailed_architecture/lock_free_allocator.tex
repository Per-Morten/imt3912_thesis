...
\subsubsection{Allocation - Single threaded}
...
\lstinputlisting[language=cpp, caption=Lock-Free Allocate, label=lst:allocate]{lock_free_allocator_code/lock_free_allocate.py}
...
\lstinputlisting[language=cpp, caption=Lock-Free Try Allocate, label=lst:try_allocate]{lock_free_allocator_code/lock_free_try_allocate.py}

\phantomsection
\paragraph{Circumventing the ABA Problem}
...
\subsubsection{Avoiding Locking}
...
\subsection{Pros of Lock Free Allocator}
