...
\todo{Remove "efficiently", as this is hard to measure.}
\requirement{NOX ECS shall efficiently provide functionality akin to virtual, for polymorphic types known at compile time.}{req:virtuals}
...
\todo{Add requirement comment structure. Comment: without large investments by the programmer}
