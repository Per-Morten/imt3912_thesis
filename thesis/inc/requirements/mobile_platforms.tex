...
Traditionally, ARM has supplied a weak memory model, meaning that synchronization primitives that ensure sequentially consistent memory ordering might lead to a performance hit. \todo{Add link to atomic weapons talk by herb sutter, mentioning that later ARM architectures will be seq\_cst}
