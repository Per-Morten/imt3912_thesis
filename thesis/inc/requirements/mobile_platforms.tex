...
As mentioned earlier \todo{mention this earlier} contiguous memory and caching mechanisms are important for good performance on modern hardware.
...
\requirement{NOX ECS should efficiently support games built for mobile platforms}{req:mobile_platform}
