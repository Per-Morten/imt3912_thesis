...
\end{gnuplot}
\caption[Numerous Components, Internal, 75 Unique Components]{Numerous Unique Components Internal, 75 unique components, time}
...
\end{gnuplot}
\caption[Fast spawning, Internal, 10 repetitions, sprites, time]{Fast Spawn ECS Internal, 10 repetitions, sprite actors, time}
...
\end{gnuplot}
\caption[Fast spawning, Internal, 10 repetitions, sprites, memory]{Fast Spawn ECS Internal, 10 repetitions, sprite actors, memory}
