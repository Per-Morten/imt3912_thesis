...
%todo: Cite: https://blog.molecular-matters.com/2013/05/17/adventures-in-data-oriented-design-part-3b-internal-references/ as the idea is based on his handles.

\lstinputlisting[language=cpp, caption=SmartHandle.cpp]{../code_samples/smart_handle.cpp}
